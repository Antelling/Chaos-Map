...
Optimized `js/pendulum-sim-cpu.js` for better performance while maintaining **64-bit double precision**.
...
### Accuracy Maintained:
- **Full 64-bit double precision** - Uses standard JavaScript numbers (not Float32Array)
